# pages/Yield.py  — US op nieuwe enriched view (strakkere UI)
...
with g2:
    st.write("")  # spacer om hoogte gelijk te trekken
...
# ================== Δ DELTAS — eerst HISTOGRAM, dan TIJDREEKS ==================
st.header("Δ Deltas (basispunten)")

# Beschikbare horizons uit enriched view
available_horizons = []
